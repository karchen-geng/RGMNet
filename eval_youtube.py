...
parser.add_argument('--model', default='saves/Nov14_08:35_s01_only_biread_1114_batch4/Nov14_08:35_s01_only_biread_1114_batch4_400000.pth')
# parser.add_argument('--yv_path', default='/mnt/31f271cb-1eab-41e4-aa15-7caf8b6e7528/gck/Dataset/YouTube_19/')  # youtube19
parser.add_argument('--yv_path', default='/mnt/31f271cb-1eab-41e4-aa15-7caf8b6e7528/gck/Dataset/YouTube_18/')  # youtube18

parser.add_argument('--output_all', default=True, help=
"""
...
parser.add_argument('--output', default='output/s01_stcn_1114_only_batch4/YouTube18_400k')
# parser.add_argument('--output', default='output/s01_mask_0724/YouTube18_400k')  # youtube18
